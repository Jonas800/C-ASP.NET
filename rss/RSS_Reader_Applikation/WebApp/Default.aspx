<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="WebApp_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--<div data-role="tabs" id="tabs">
        <div data-role="navbar">
            <ul>
                <li><a href="Default.aspx" data-ajax="true">Nyheder</a></li>
                <li><a href="Settings.aspx" data-ajax="true">Indstillinger</a></li>
            </ul>
        </div>
    </div>--%>
