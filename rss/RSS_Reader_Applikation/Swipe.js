...
//jQuery Mobile Demos version 1.4.5
...
$(document).one("pagecreate", ".demo-page", function () {
    ...
    function navnext(next) {
        $(":mobile-pagecontainer").pagecontainer("change", next + ".aspx", {
            transition: "slide"
        });
    }
    // Handler for navigating to the previous page
    function navprev(prev) {
        $(":mobile-pagecontainer").pagecontainer("change", prev + ".aspx", {
            transition: "slide",
            reverse: true
        });
    }
...
//    if (next) {
//        $(":mobile-pagecontainer").pagecontainer("load", next + ".aspx");
//    }
